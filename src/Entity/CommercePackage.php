...
use App\Repository\CommercePackageRepository;
...
class CommercePackage
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CommerceUserSubscription::class, mappedBy="CommercePackageAssoc")
     */
    private $commerceUserSubscriptions;

    /**
     * @ORM\ManyToOne(targetEntity=CommercePackageGroup::class, inversedBy="CommercePackage")
     */
