...
use App\Repository\CommerceTransactionRepository;
...
class CommerceTransaction
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=CommercePurchase::class, cascade={"persist", "remove"})
     */
    private $commercePurchase;

    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="commerceTransactions")
     */
    private $user;
