...
use App\Repository\CommerceUserSubscriptionRepository;
use DateInterval;
...
class CommerceUserSubscription
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=User::class, inversedBy="CommerceUserSubscriptions")
     * @ORM\JoinColumn(nullable=false)
     */
    private $user;

    /**
     * @ORM\ManyToOne(targetEntity=CommercePackage::class, inversedBy="commerceUserSubscriptions")
     * @ORM\JoinColumn(nullable=false)
     */
